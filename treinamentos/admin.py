...
class TreinamentoAdmin(admin.ModelAdmin):
    ...
    list_filter = ("norma", "validade_passaporte")  # Filtros laterais
    search_fields = ("funcionario__nome_completo", "nome_treinamento")  # Busca pelo nome
    ordering = ("validade_passaporte",)  # Ordena por data de validade do passaporte
